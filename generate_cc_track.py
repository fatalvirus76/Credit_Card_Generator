...
# Generate credit card numbers and Track 1/2 data
def generate_cards():
    ...
    for _ in range(count):
        ...
        if verify(card_number):
            ...
            result_text.insert(END, f"Card Number: {card_number}\n")
            result_text.insert(END, f"Track 1: {track1}\n")
            result_text.insert(END, f"Track 2: {track2}\n\n")
        else:
